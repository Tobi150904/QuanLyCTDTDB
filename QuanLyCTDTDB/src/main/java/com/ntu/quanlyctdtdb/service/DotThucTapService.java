...
public interface DotThucTapService {
    ...
    /**
     * Bug-fix #8 - Filter: SV chi thay cac dot TT ma minh tham gia.
     * Tra ve list {@link DotThucTap} de render trong danh sach page.
     */
    List<DotThucTap> findDotCuaSinhVien(String maNguoiDung);

    /**
     * Bug-fix #4 - Ownership check: user co quyen xem chi tiet dot TT khong?
     * Quy tac:
     * <ul>
     *   <li>SV: phai co trong danh sach SV cua dot.</li>
     *   <li>GV/CVHT: day HP cua dot (theo DoiNguGiangVienHP) HOAC la co van
     *       cua it nhat 1 SV trong dot.</li>
     *   <li>DN: co SV trong dot duoc phan cong cho chinh DN nay.</li>
     * </ul>
     */
    boolean canUserViewDot(Integer maDotTT,
                            com.ntu.quanlyctdtdb.security.CustomUserDetails ud);
